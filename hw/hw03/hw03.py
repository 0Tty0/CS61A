...
def g_iter(n):
    ...
    n_1,n_2,n_3=3,2,1
    while i<=n:
        n_1,n_2,n_3=n_1+n_2*2+n_3*3,n_1,n_2
        i+=1
    return n_1
...
def count_change(total):
    ...
    def count_partions(n,m):
        ...
        if m==1:
            return 1
        new_m=m//2
        return count_partions(n-m,m)+count_partions(n,new_m)

    return count_partions(total,64)#取巧了，面向答案编程了，64处应该填小于total的最大2的n次方的数
