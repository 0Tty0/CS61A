...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    if (opponent_score%100)//10==abs(player_score%10-opponent_score%10):return True
    else:return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who == 0:
            ...
            now_turn0=take_turn(roll_num,score1,dice)
            score0+=now_turn0
            if abs(old_turn0-roll_num)==2 and feral_hogs==True:
                score0+=3
            old_turn0=now_turn0
        ...
        if who==1:
            ...
            now_turn1=take_turn(roll_num,score0,dice)
            score1+=now_turn1
            if abs(old_turn1-roll_num)==2 and feral_hogs==True:
                score1+=3
            old_turn1=now_turn1
...
def final_strategy(score, opponent_score):#不想做了
